    ...
    <main className="min-h-screen bg-zinc-50 py-16 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Link href="/admin/analytics" className="bg-white border border-zinc-200 rounded-2xl p-6 hover:border-zinc-400 transition">
            <h2 className="text-xl font-semibold mb-2">Analytics</h2>
            <p className="text-zinc-500">View business insights and reports</p>
          </Link>
        </div>
      </div>
    </main>
